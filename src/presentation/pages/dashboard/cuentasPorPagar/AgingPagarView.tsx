...
export const AgingPagarView = () => {
  const navigate = useNavigate();
  const { aging, loading, fetchAging } = useCuentasPorPagar();
  ...
  if (loading || !aging) {
    return <div className="text-center py-12 text-slate-400 font-bold text-sm">Cargando aging de cuentasPorPagar...</div>;
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="tuto-aging-charts grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        {/* Pie Chart */}
        <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-6">
          <h3 className="font-black text-slate-700 text-sm uppercase tracking-widest mb-4">Proporción de CuentasPorPagar</h3>
          <ResponsiveContainer width="100%" height={260}>
            <PieChart>
              <Pie
                data={pieData}
