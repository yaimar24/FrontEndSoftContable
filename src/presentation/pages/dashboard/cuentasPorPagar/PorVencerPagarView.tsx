...
import type { FacturaPorVencerPagar } from '../../../../domain/models/CuentasPorPagar';
import { FileText, Eye } from 'lucide-react';
import { formatCurrency } from '../../../../utils/formatters';
import { ModuleGate } from '../../../components/shared/ModuleGate';

export const PorVencerPagarView = () => {
  const navigate = useNavigate();
  const { porVencer, loading, fetchPorVencer } = useCuentasPorPagar();
  ...
  const columns: Column<FacturaPorVencerPagar>[] = [
    {
      header: 'Factura',
      render: (item) => (
