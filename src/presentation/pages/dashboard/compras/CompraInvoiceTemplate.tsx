    ...
    <div className="w-full h-full bg-white print:p-0 p-5 sm:p-5 text-slate-800 text-sm">
      ...
      <div className="grid grid-cols-2 gap-5 mb-10">
        <div className="bg-slate-50 p-5 rounded-2xl border border-slate-100">
          ...
          <p className="text-xs text-slate-600 font-medium mb-1"><span className="text-slate-400">Teléfono:</span> {factura.proveedorTelefono || 'N/A'}</p>
          <p className="text-xs text-slate-600 font-medium"><span className="text-slate-400">Dirección:</span> {factura.proveedorDireccion || 'N/A'}</p>
        </div>
