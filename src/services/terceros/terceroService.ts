...
export const searchClientes = async (nombre: string): Promise<ApiResponse<TerceroupdateDTO[]>> => {
  return await apiClient(`/api/Tercero/clientes?nombre=${encodeURIComponent(nombre)}`);
};
